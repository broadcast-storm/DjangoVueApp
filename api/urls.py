...
from .views import JobPositionViewSet, DivisionViewSet, UserProfileViewSet, StatisticsViewSet, \
    TaskViewSet, WeeklyTaskViewSet, TeamsViewSet, login, refresh_token, logout, createCompetition
...
urlpatterns = [
    ...
    path('createCompetition', createCompetition, name='createCompetition')
]
