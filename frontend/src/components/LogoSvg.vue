<template>
    ...
    >
        ...
        >
            <path
                d="M42 35H51C53.7614 35 56 37.2386 56 40V75C56 77.7614 53.7614 80 51 80H7C4.23858 80 2 77.7614 2 75V40C2 37.2386 4.23858 35 7 35H15"
                stroke-width="3"
                :stroke="color"
            />
            <circle
...
export default {
    ...
    methods: {
        mouseOver() {
            if (this.canBeActive) this.color = this.activeColor
        },
        mouseLeave() {
            if (this.canBeActive) this.color = this.regularColor
        },
    },
}
</script>
